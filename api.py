...
class PetFriends:
    ...
    def __init__(self):
        ...
        """Метод __init__ присваивает всем экземплярам класса PetFriends базовый URL"""


    def get_api_key(self, email: str, password: str) -> json:
        """Метод делает get-запрос к API и возвращает статус запроса и результат запроса в формате JSON
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: str, pet_photo: str) -> json:
        """Метод добавляет нового питомца на сайт и возвращает информацию о добавленном питомце в формате JSON"""
